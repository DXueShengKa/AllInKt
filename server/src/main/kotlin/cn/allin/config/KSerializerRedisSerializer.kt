...
class KSerializerRedisSerializer<T>(
    ...
    override fun serialize(value: T?): ByteArray? {
        return binaryFormat.encodeToByteArray(serializer, value ?: return null)
    }
    ...
    override fun canSerialize(type: Class<*>): Boolean {
        return serializer == type.kotlin.serializerOrNull()
    }

    override fun getTargetType(): Class<*> {
        return clazz
    }
}
