...
val DefaultVirtualExecutor: ExecutorService =
...
inline fun <reified T : Any> Cache.getValue(key: Any): T? = this.get(key, T::class.java)
...
fun newAuthenticationToken(
    id: Long,
    password: String,
    authorities: List<UserRole>,
...
private object UserAuthenticationSerializable : KSerializer<UserAuthenticationToken> {
    override val descriptor: SerialDescriptor =
        buildClassSerialDescriptor(UserAuthenticationToken::class.jvmName) {
            element<Long>("id")
